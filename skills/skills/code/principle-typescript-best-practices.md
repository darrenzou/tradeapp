...
Apply the [principle-type-system-discipline](principle-type-system-discipline.md) principle skill first; this skill grounds it in TypeScript syntax.
...
| Boundary validation   | Validate where data crosses in; trust types inside. See the [principle-boundary-discipline](principle-boundary-discipline.md) principle skill.                                                                 |
